...
- Name: 📄 Deep Resume Management Testing >> should upload valid PDF resume successfully
- Location: C:\Users\POOJA\OneDrive\Documents\AutoApplyPro\tests\09-resume-management-deep.spec.js:66:3
...
Call log:
  ...
  - waiting for locator('input[type="file"]')
    ...
    at C:\Users\POOJA\OneDrive\Documents\AutoApplyPro\tests\09-resume-management-deep.spec.js:74:29
```
...
```ts
   ...
   5 |
   6 | /**
   7 |  * DEEP RESUME MANAGEMENT TESTING
   8 |  * 
   9 |  * This test suite performs comprehensive testing of:
   10 |  * - Resume upload functionality (PDF/DOCX validation)
