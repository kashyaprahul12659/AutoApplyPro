...
- Name: 📄 Deep Resume Management Testing >> should reject files larger than 5MB
- Location: C:\Users\POOJA\OneDrive\Documents\AutoApplyPro\tests\09-resume-management-deep.spec.js:138:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('text=less than 5MB') resolved to 2 elements:
    1) <div>File size should be less than 5MB</div> aka getByText('File size should be less than').first()
    2) <div>File size should be less than 5MB</div> aka getByText('File size should be less than').nth(1)

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=less than 5MB')

    at C:\Users\POOJA\OneDrive\Documents\AutoApplyPro\tests\09-resume-management-deep.spec.js:148:73
```
