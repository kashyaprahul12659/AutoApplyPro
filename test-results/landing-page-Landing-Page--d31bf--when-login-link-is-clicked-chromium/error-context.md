...
```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: /login/i }) resolved to 2 elements:
...
Call log:
  - waiting for getByRole('link', { name: /login/i })
    ...
    at C:\Users\POOJA\AutoApplyPro\tests\landing-page.spec.js:44:54
```
