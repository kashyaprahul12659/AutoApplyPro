...
- Name: Landing Page >> should display the hero section
- Location: C:\Users\POOJA\AutoApplyPro\tests\landing-page.spec.js:31:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('section') resolved to 5 elements:
    1) <section class="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">…</section> aka locator('section').filter({ hasText: 'Apply to jobs 10x faster with' })
    2) <section class="py-16 bg-gray-50">…</section> aka locator('section').filter({ hasText: 'Powerful FeaturesEverything' })
    3) <section class="py-16 bg-white">…</section> aka locator('section').filter({ hasText: 'What Our Users SayJoin' })
    4) <section class="py-16 bg-gray-50">…</section> aka locator('section').filter({ hasText: 'Simple, Transparent' })
    5) <section class="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">…</section> aka locator('section').filter({ hasText: 'Ready to transform your job' })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('section')

    at C:\Users\POOJA\AutoApplyPro\tests\landing-page.spec.js:34:31
```
